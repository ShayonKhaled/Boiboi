<template>
  <c-box>
    <div v-if="$isMobile()">
       <c-text fontSize="xl" textAlign="center" p="10"> <br /> <br /> <b> 😞 I see you're using a mobile. Could you please switch to PC? My apologies, this is still a work in progress and not quite mobile-friendly yet. </b>
       </c-text>
    </div>
<div v-else>
